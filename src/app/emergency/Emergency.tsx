...
function Emergency() {
  return (
     <div className="bg-white shadow-lg rounded-xl overflow-hidden w-[300px]  mx-auto mt-10">
      ...
      {/* Form content */}
      <div className="p-6  space-y-3 absolute mx-auto bg-gradient-to-b from-[#F0F5FF] to-white w-[300px] -mt-14 rounded-t-3xl rounded-b-xl">
        ...
        <h1 className=" font-bold text-xl text-center mt-5">Emergency contact</h1>
        <p className="text-center  text-black text-[14px] mb-6">
          ...
          <div className="mb-4 ">
            <Label htmlFor="email" className="mb-2">
              Relation with the contact person
            </Label>
            <div className="relative bg-white rounded-lg">
              <Input
                id="email"
          ...
          <div className="flex justify-between mt-6 items-center mt-60">
            <div>
              <FaArrowLeftLong />
            </div>
            <div>
